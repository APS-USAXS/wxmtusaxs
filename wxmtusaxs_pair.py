...
# $Date: 2013-10-27 11:10:56 -0500 (Sun, 27 Oct 2013) $
# $Author: jemian $
# $Revision: 866 $
# $URL: https://subversion.xray.aps.anl.gov/small_angle/USAXS/wxmtusaxs/trunk/wxmtusaxs_pair.py $
# $Id: wxmtusaxs_pair.py 866 2013-10-27 16:10:56Z jemian $
########### SVN repository information ###################
'''
...
class XYpair(wx.Panel):
    ...
    def __init__(self, parent, name, root, rootCallback, newtab=False):
        ...
        self.titles = {}
        for axis in ['x', 'y']:
            self.epics[axis] = wxmtusaxs_axis.Axis()
            self.titles[axis] = {}
...
# ################################
    ...
    def NewTab(self, newrow=True):
        ...
        panel = wxmtusaxs_tab.Tab(parent=self.table, pair=self,
    ...
    def CallbackPositions(self, epics_args, user_args):
        ...
        if epics_args.has_key('pv_precision'):
            ...
            fmt = '%.' + str(epics_args['pv_precision']) + 'f'
            #abs_value = abs(value)
    ...
    def ConnectEpics(self):
        ...
        #+++++++++++++++++++++++++++++++
        # need to replace this starting from the example in wxmtusaxs_axis.main()
        #+++++++++++++++++++++++++++++++
        for axis in ['x', 'y']:
