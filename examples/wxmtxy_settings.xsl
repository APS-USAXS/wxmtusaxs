...
# $Date: 2011-05-20 16:22:14 -0500 (Fri, 20 May 2011) $
# $Author: pbeaucage $
# $Revision: 472 $
# $URL: https://subversion.xor.aps.anl.gov/small_angle/USAXS/wxmtusaxs/examples/wxmtxy_settings.xsl $
# $Id: wxmtxy_settings.xsl 472 2011-05-20 21:22:14Z pbeaucage $
########### SVN repository information ###################
-->
